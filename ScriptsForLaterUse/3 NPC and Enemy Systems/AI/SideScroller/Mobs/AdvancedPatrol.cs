...
namespace MoreMountains.CorgiEngine
{
    ...
    [AddComponentMenu("Corgi Engine/Character/AI/Actions/AI Action Advanced Patrol")]
public class AdvancedPatrol : AIAction
{
    ...
    public Vector2 ObstaclesDetectionRaycastOrigin = new Vector2(0.5f, 0f);
        ...
        [Tooltip("How far from the origin point the character can patrol")]
    ...
    protected Vector2 _obstacleDirection;
        ...
        protected Timer ChangeDirectionTimer;
        protected float ChangeDirectionDelay = 10f;
        protected Timer StallTimer;
        protected float StallDelay = 0.5f;
        ...
        public override void Initialization()
    {
        ...
        _initialScale = transform.localScale;
            ...
            ChangeDirectionTimer = new Timer(ChangeDirectionDelay);
    ...
    protected virtual void CheckForWalls()
    {
        ...
        else
        {
            ...
            if (ChangeDirectionTimer.ClockTick())
            {
                if (Vector2.Distance(_initialPosition, transform.position) > MaxPatrolDistance)
                {
                    ChangeDirection();
                    ChangeDirectionTimer.RestartTimer();
                }
            }
    }
