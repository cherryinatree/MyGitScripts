...
public class CSM_RecordableList
{
    ...
    public delegate void ActionDelegate(CSM_RecordableList list);
    public delegate bool ActionBoolDelegate(CSM_RecordableList list);
    public delegate void AddDropdownDelegate(Rect buttonRect, CSM_RecordableList list);
    public delegate Object DragDropReferenceDelegate(Object[] references, CSM_RecordableList list);
    public delegate void DragDropAppendDelegate(Object reference, CSM_RecordableList list);
    public delegate float GetElementHeightDelegate(SerializedProperty element);
    public delegate float GetElementsHeightDelegate(CSM_RecordableList list);
    ...
    public CSM_RecordableList(SerializedProperty list)
        : this(list, true, true, true)
    {
    }

    public CSM_RecordableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
        : this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null)
    {
    }

    public CSM_RecordableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon)
        : this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon)
    {
    }

    public CSM_RecordableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon)
    {
    ...
    */
    ...
    static class Style
    {
        ...
        static Style()
        {
            ...
            expandButton = EditorGUIUtility.IconContent("Packages/com.unity.ugui/Editor Resources/Textures/SectionHeader_Light.psd");
