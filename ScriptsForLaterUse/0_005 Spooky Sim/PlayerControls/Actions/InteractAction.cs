...
public class InteractAction : PlayerAction
{
    ...
    public MonoBehaviour[] subscribeToOnInteract;
    ...
    protected void Start()
    {
        ...
        SaveData.Current.mainData.playerData.money += 10000; // for testing
        Debug.Log("added 10000 for testing");
    }
    ...
    {
        if (subscribeToOnInteract != null)
        {
            foreach (var mb in subscribeToOnInteract)
            {
                if (mb != null)
                {
                    mb.SendMessage("OnPlayerInteract", SendMessageOptions.DontRequireReceiver);
                }
            }
        }
