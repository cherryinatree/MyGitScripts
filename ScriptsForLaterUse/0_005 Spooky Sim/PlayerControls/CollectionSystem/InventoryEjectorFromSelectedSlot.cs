    ...
    public class InventoryRightClickEjectSelected : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            while (_timer >= ejectInterval)
            {
                ...
                if (!TryEjectOne())
                {
                    if (ejectAudioSource != null && EmptySound != null)
                        ejectAudioSource.PlayOneShot(EmptySound);
                   // _held = false;
                   // break;
                }
                else
                {
                    ...
                    if (ejectAudioSource != null && ejectSound != null)
                        ejectAudioSource.PlayOneShot(ejectSound);
                }
            }
        }
