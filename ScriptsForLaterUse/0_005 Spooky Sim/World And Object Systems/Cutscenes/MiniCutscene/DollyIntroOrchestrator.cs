...
public class DollyIntroOrchestrator : MonoBehaviour
{
    ...
    public CinemachineVirtualCameraBase dollyCmCamera;     // CinemachineCamera (CM3)
    ...
    public int cutScenePriority = 51;
    ...
    /* e.g. your movement script or PlayerInput if you don't want it to tick this frame */
       // });
        ...
        //if (cutscenePhysicalCamera) cutscenePhysicalCamera.
        //dollyCmCamera.Priority = cutScenePriority;
