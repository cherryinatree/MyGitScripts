...
public class CombatStateMachine : CharacterAbility
{
    ...
    public PlayerSaveInteraction playerSaveInteraction;
    ...
    {
        if (playerSaveInteraction == null || characterTransform == null || animator == null || characterStatus == null)
        {
