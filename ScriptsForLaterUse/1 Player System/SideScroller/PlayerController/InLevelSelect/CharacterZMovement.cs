...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterZMovement : CharacterAbility
{
    ...
    protected override void HandleInput()
    {
        ...
        {
            _horizontalMovement = Mathf.Lerp(_lastGroundedHorizontalMovement, _verticalInput, AirControl);
        }
    }
    ...
    protected virtual void HandleHorizontalMovement()
    {
        ...
        _horizontalMovementForce = HandleFriction(_horizontalMovementForce);
            ...
            transform.position += new Vector3(0, 0, _horizontalMovementForce);
