...
public class CorePlayer : MonoBehaviour
{
    ...
    // ---- Input Actions ----
    private InputAction _aMove, _aLook, _aSprint, _aJump, _aInteract, _aClick;
    ...
    private void Awake()
    {
        ...
        Body.constraints = RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationZ; // yaw only
    ...
    private void OnEnable()
    {
        ...
        if (_aClick != null) { _aClick.started += _ => OnClickStarted?.Invoke(); _aClick.canceled += _ => OnClickCanceled?.Invoke(); }
    }
