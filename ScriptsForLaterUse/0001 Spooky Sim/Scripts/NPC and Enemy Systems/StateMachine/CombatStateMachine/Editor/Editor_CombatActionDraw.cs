...
[CustomPropertyDrawer(typeof(CombatAction))]
public class Editor_CombatActionDraw : PropertyDrawer
{
    ...
    {
        CombatAction thisAction = prop.objectReferenceValue as CombatAction;
        CombatAction[] actions = (prop.serializedObject.targetObject as CombatStateMachine).GetAttachedActions();
        int selected = 0;
        int i = 1;
